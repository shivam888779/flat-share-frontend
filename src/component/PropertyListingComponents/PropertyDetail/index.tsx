...
import { RadioInputWithImage } from "@/custom-component";
        ...
        >
          {({ handleChange, values, touched, errors,setFieldValue }) => (
            <Form>
               ...
               <CustomizedRoundedIcon handleChange = {setFieldValue} selectedHighLights = {values?.hightLights} />
              </div>
              <div className="mb-4">
                <label className="font-semibold">Property Title</label>
                <TextField
